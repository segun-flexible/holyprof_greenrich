...
//FETCH UPLINE
authRoute.route("/register/search").get(generalData, fetchUplineGet)
...
//VERIFICATION
authRoute.route("/verification").get(generalData, userDetails, isUserLogin,reSendNewVerificationMail);
